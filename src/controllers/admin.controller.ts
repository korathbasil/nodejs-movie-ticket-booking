...
export class AdminController {
  ...
  public static getTheaters(_: Request, res: Response) {
    res.render("admin/theaters", {
      title: "Thaters - Admin - Cinemax",
      adminRoute: true,
    });
  }

  // GET /admin/users
  public static getUsers(_: Request, res: Response) {
    res.render("admin/users", {
      title: "Users - Admin - Cinemax",
      adminRoute: true,
    });
  }

  // GET /admin/managers
  public static getManagers(_: Request, res: Response) {
    res.render("admin/managers", {
      title: "Managers - Admin - Cinemax",
      adminRoute: true,
    });
  }
